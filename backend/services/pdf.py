...
def generate_offer_pdf(inquiry: dict, lang: str = "de") -> bytes:
    ...
    pdf.cell(0, 6, "TRUCKSonROAD GmbH | Bahnhofstrasse 75, 8620 Wetzikon | +41 79 696 98 99 | info@truckonroad.ch", ln=True, align="C")
    pdf.ln(8)
...
async def generate_veranstalter_pdf() -> bytes:
    ...
    pdf.set_font("Helvetica", "", 10)
    pdf.cell(0, 6, "TRUCKSonROAD GmbH", ln=True)
