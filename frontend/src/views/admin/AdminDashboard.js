...
import {
  ...
  Settings, HelpCircle, Users, Download, DollarSign, MapPin, Star, Sparkles, BookOpen
} from 'lucide-react';
...
function AdminLayout({ children, title }) {
  ...
  const navItems = [
    ...
    { to: '/admin/mitarbeiter', icon: Users, label: t('admin_employees') },
    ...
    { to: '/admin/blog', icon: BookOpen, label: t('admin_blog') },
    ...
    <div className="adm" data-testid="admin-layout">
      ...
      <aside className={`adm-sidebar ${sidebarOpen ? 'open' : ''}`} data-testid="admin-sidebar">
          ...
          <div className="adm-nav-section">
            ...
            {navItems.map(item => (
              <Link
                key={item.to}
                href={item.to}
                className={`adm-nav-link ${pathname === item.to ? 'active' : ''}`}
        ...
        <div className="adm-sidebar-footer">
          <Link href="/" className="adm-nav-link" data-testid="admin-nav-website" onClick={() => setSidebarOpen(false)}>
    ...
    <AdminLayout title={t('admin_dashboard')}>
      ...
      <div className="adm-table-wrap" data-testid="recent-inquiries-section">
        <div className="adm-table-header">
          ...
          <Link href="/admin/anfragen" className="adm-btn adm-btn-secondary adm-btn-sm" data-testid="view-all-inquiries-link">
            {t('admin_show_all')}
          </Link>
        </div>
