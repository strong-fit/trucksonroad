    ...
    <div className="sf-portal" data-testid="customer-portal">
      <header className="sf-portal-header" data-testid="portal-header">
        <div className="sf-portal-header-inner">
          <Link href="/" className="sf-auth-logo" style={{ textDecoration: 'none' }}>
      ...
      <div className="sf-portal-content">
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <Link href="/anfrage" className="sf-btn-primary" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }} data-testid="new-inquiry-btn">
        ...
        {loading ? (
          ...
          <div className="sf-portal-empty" data-testid="portal-empty">
            ...
            <p>{t('portal_empty')}</p>
            <Link href="/anfrage" className="sf-btn-primary" style={{ marginTop: '1rem', textDecoration: 'none' }}>{t('portal_empty_cta')}</Link>
          </div>
        ) : (
